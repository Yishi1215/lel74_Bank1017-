...
public class MySQLUtilities implements DbUtilities{
    ...
    private String dbName = "lel74_bank1017"; // default database name
    private String dbUserName = "lel74"; // login name for the database server
    private String dbPassword = "3892023"; // password for the database server
